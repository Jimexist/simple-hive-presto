...
ADD http://mirrors.ocf.berkeley.edu/apache/hadoop/common/stable/hadoop-2.7.2.tar.gz /opt/
ADD http://mirrors.ocf.berkeley.edu/apache/hive/stable/apache-hive-1.2.1-bin.tar.gz /opt/
